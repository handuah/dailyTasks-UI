...
class TasksForToday extends StatefulWidget {
  // const TasksForToday({ Key? key }) : super(key: key);

  @override
  _TasksForTodayState createState() => _TasksForTodayState();
}
    ...
    return Padding(
      ...
      child: ListView(
        ...
        children: [
          ...
          TaskCards("#E98F8F", 'Cleaning the house', "#F9FAFD", "12:00 - 14:00",
              "#E98F8F", "#F6E4E6", "#E98F8F", "#F6E4E6"),
          SizedBox(
            height: MediaQuery.of(context).size.height * 0.02,
          ),
        ],
